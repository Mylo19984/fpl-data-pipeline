...
from includes import ply_stats_s3_to_postgre, week_info_s3_to_postgre
...
args = {
    'owner': 'Mylo',
    'start_date': datetime(year=2022, month=9, day=21, hour=12)
}
...
with dag:
    ...
    insert_week_inf_postgre = PythonOperator(
        task_id='week_info_data_postgre',
        provide_context=True,
        python_callable=week_info_s3_to_postgre
    )


create_db_schema_tables >> get_id_data >> pul_data_s3 >> insert_team_data_postgre >> insert_gen_data_postgre

insert_gen_data_postgre >> insert_week_data_postgre >> insert_player_stats_postgre >> insert_week_inf_postgre
